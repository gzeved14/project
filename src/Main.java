...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("-");
        System.out.println("Conteúdos Concluído Gabriel" + devGabriel.getConteudosConcluidos());
        ...
        devPaulo.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Concluído Paulo" + devPaulo.getConteudosConcluidos());
